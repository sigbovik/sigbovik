...
\newcommand{\addpaper}[1][fancy]{%
  \def\CurrentPaperPageStyle{#1}%
  \addpaperrelay}
\newcommand{\addpaperrelay}[7][]{
	\cfoot{\vspace{-#6}\quad\colorbox{white}{\parbox[t][#6][b]{3em}{\center{\thepage}}}}
	\rhead{#7}
	\includepdf[pages=-,pagecommand={\thispagestyle{\CurrentPaperPageStyle}},addtotoc={1,subsection,1,{#2},{title:#5},1,subsubsection,4,{#3},{author:#5},1,paragraph,4,{#4},{#5}},picturecommand={\rhead{}},picturecommand*={\hspace{5.5in}\vspace*{-10.5in} {#1}}]{./papers/#5}}
...
\newcommand{\badge}[1]{\includegraphics[width=1in]{badges/badge_#1}}
