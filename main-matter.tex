...
\newcommand{\addpaper}[5]{
	\setfootershift{#5}
	\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,subsection,1,{#1},{title:#4},1,subsubsection,4,{#2},{author:#4},1,paragraph,4,{Keywords: #3},{keywords:#4}}]{./papers/#4}}
