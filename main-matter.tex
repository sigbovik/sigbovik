...
\newcommand{\addpaper}[6]{
	\cfoot{\vspace{-#5}\quad\colorbox{white}{\parbox[t][#5][b]{3em}{\center{\thepage}}}}
	\rhead{#6}
	\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,subsection,1,{#1},{title:#4},1,subsubsection,4,{#2},{author:#4},1,paragraph,4,{#3},{#4}},picturecommand={\rhead{}}]{./papers/#4}}
