...
%%%% two fields.
\papernum{17}
\papertitle{GradSchoolNet:\@ Robust end-to-end *-shot unsupervised deepAF neurla attention model for convexly optimal (artifically intelligent) success in computer vision research}
