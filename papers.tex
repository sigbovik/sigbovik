...
\addtrack{Rototiller track}{Special Offers}
\addpaper
...
\addpaper
	...
	{}
\addpaper
	{$\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox$ $\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox$ $\bigbox\bigbox\bigbox\bigbox$ $\bigbox\bigbox\bigbox\bigbox\bigbox$ $\bigbox\bigbox\bigbox\bigbox\bigbox$ $\bigbox\bigbox$ $\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox$}
	{$\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox$ $\bigbox\bigbox\bigbox$ $\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox$ and $\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox$ $\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox\bigbox$}
	{}
